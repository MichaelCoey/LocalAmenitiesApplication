...
public class BelfastCityCouncilInformation_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position)
        {
            ...
            case 1:
                textElement = (TextView) findViewById(R.id.txtBCCSDescription);
                textElement.setText(R.string.BCCIM_Spinner_description_BuildingControl);

                textElement = (TextView) findViewById(R.id.txtBCCSContact);
                textElement.setText(R.string.BCCIM_Spinner_contact_BuildingControl);

                textElement = (TextView) findViewById(R.id.txtBCCSAdditional);
                textElement.setText(R.string.BCCIM_Spinner_additional_BuildingControl);
                break;
            case 2:
                textElement = (TextView) findViewById(R.id.txtBCCSDescription);
                textElement.setText(R.string.BCCIM_Spinner_description_Cemeteries);

                textElement = (TextView) findViewById(R.id.txtBCCSContact);
                textElement.setText(R.string.BCCIM_Spinner_contact_Cemeteries);

                textElement = (TextView) findViewById(R.id.txtBCCSAdditional);
                textElement.setText(R.string.BCCIM_Spinner_additional_Cemeteries);
                break;
            case 3:
                textElement = (TextView) findViewById(R.id.txtBCCSDescription);
                textElement.setText(R.string.BCCIM_Spinner_description_Dogs);

                textElement = (TextView) findViewById(R.id.txtBCCSContact);
                textElement.setText(R.string.BCCIM_Spinner_contact_Dogs);

                textElement = (TextView) findViewById(R.id.txtBCCSAdditional);
                textElement.setText(R.string.BCCIM_Spinner_additional_Dogs);
                break;
            case 4:
                textElement = (TextView) findViewById(R.id.txtBCCSDescription);
                textElement.setText(R.string.BCCIM_Spinner_description_WasteRecycling);

                textElement = (TextView) findViewById(R.id.txtBCCSContact);
                textElement.setText(R.string.BCCIM_Spinner_contact_WasteRecycling);

                textElement = (TextView) findViewById(R.id.txtBCCSAdditional);
                textElement.setText(R.string.BCCIM_Spinner_additional_WasteRecycling);
                break;
        }
    }
